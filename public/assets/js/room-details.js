...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function renderCalendar(date) {
        ...
        for (let i = 1; i <= daysInMonth; i++) {
            ...
            if (hasBookingsOnDate(cellDateStr)) {
                ...
                dot.style.cssText = "width: 4px; height: 4px; background: #EF4444; border-radius: 50%; margin: 2px auto 0;";
    ...
    function renderSchedule(date) {
        ...
        // Simple "Available" filler logic could be added here similar to the original mock
        // but for now showing just the bookings is a massive improvement.
    }
});
